...
**Image version:** 0.1.10

**Source release/branch:** [v0.2.15](https://github.com/devcontainers/images/tree/v0.2.15/src/jekyll)
...
**Digest:** sha256:e12f63808cef0af04c2b6b6d6b6ff8afc8eddf241d8ec7801e7173dd13ac79b0

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.10-2.7-bullseye
mcr.microsoft.com/devcontainers/jekyll:0.1.10
mcr.microsoft.com/devcontainers/jekyll:0.1.10-bullseye
```
...
**Digest:** sha256:10e2c4f31dce6afbe8a86c91d59433abfc5f0463a8534120f9fd01021d672d47

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.10-2.7-buster
mcr.microsoft.com/devcontainers/jekyll:0.1.10-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
