...
**Image version:** 0.1.15

**Source release/branch:** [v0.2.29](https://github.com/devcontainers/images/tree/v0.2.29/src/jekyll)
...
**Digest:** sha256:4bd36d905b2819b503f880b7f6c22539c11ec51a0187ac39e3f3654c7fe16c76

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.15-2.7-bullseye
mcr.microsoft.com/devcontainers/jekyll:0.1.15
mcr.microsoft.com/devcontainers/jekyll:0.1.15-bullseye
```
...
**Digest:** sha256:93457b09b819a6f58fde2b0a892f2cdae2448d36bbc03c4fd349b9aa8015fb3e

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.15-2.7-buster
mcr.microsoft.com/devcontainers/jekyll:0.1.15-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
