...
**Source release/branch:** [v0.2.9](https://github.com/devcontainers/images/tree/v0.2.9/src/jekyll)
...
**Digest:** sha256:6e1b37d9c14f9c959280ca56c6a561e1bf320d9c3887fbc33d31b7f755b4d6b2

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.9-2.7-bullseye
mcr.microsoft.com/devcontainers/jekyll:0.1.9
mcr.microsoft.com/devcontainers/jekyll:0.1.9-bullseye
```
...
| [ruby-build](https://github.com/rbenv/ruby-build.git) | b0ef7c8bd0f9491dc1b8a655ebe0f183b5379f1b | /usr/local/share/ruby-build |
...
**Digest:** sha256:a345b099aa07921ec650aeccb86b25b7c193b5653846bcf4ebe287776563954e

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.9-2.7-buster
mcr.microsoft.com/devcontainers/jekyll:0.1.9-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
