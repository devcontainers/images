...
**Source release/branch:** [v0.1.0](https://github.com/devcontainers/images/tree/v0.1.0/src/jekyll)
...
**Digest:** sha256:a305b08abc306e34a389d85c0f6872cab4ae92b4823aefbb9e680dbc3c85b886

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.7-2.7-bullseye
mcr.microsoft.com/devcontainers/jekyll:0.1.7
mcr.microsoft.com/devcontainers/jekyll:0.1.7-bullseye
```
...
**Digest:** sha256:c50da09b6ca713f1ec3b0dee8ba41542dc2160f19b249605a8f0dd642a46ba6a

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.7-2.7-buster
mcr.microsoft.com/devcontainers/jekyll:0.1.7-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
