...
**Image version:** 0.1.11

**Source release/branch:** [v0.2.17](https://github.com/devcontainers/images/tree/v0.2.17/src/jekyll)
...
**Digest:** sha256:8acc4d808662e92ba1c59a70ecb723680a048442e2125aba0ae489ef4f7125f5

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.11-2.7-bullseye
mcr.microsoft.com/devcontainers/jekyll:0.1.11
mcr.microsoft.com/devcontainers/jekyll:0.1.11-bullseye
```
...
**Digest:** sha256:d12b0da88b34bd00650858a0e3b8bd3a0207971a1522c840a9c87eeda1492108

**Tags:**
```
mcr.microsoft.com/devcontainers/jekyll:0.1.11-2.7-buster
mcr.microsoft.com/devcontainers/jekyll:0.1.11-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
