...
**Digest:** sha256:dbba2f613fa768a617fe008ba8aefb956732db023de08dcb675397bae24e48c8
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 20.19.3<br />22.17.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
...
| [.NET](https://dotnet.microsoft.com/) | 8.0.412 | /usr/share/dotnet/dotnet |
...
| [Go](https://golang.org/dl) | 1.24.5 | /usr/local/go |
| [Jekyll](https://jekyllrb.com/) | 4.4.1 | 
| [Jupyter Lab](https://jupyter.org/) | 4.4.4 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 3e7ef0182f59c7990a52cf6ec2981adb56d5b368 | /home/codespace/.oh-my-zsh |
...
| github.com/mgechev/revive | 1.11.0 |
...
| [Xdebug](https://xdebug.org/) | 3.4.4 | /usr/local/php/current |
| [Composer](https://getcomposer.org/) | 2.8.10 | /usr/local/php/current/bin |
| [kubectl](https://github.com/kubernetes/kubectl) | v1.33.2 | /usr/local/bin |
| [Helm](https://github.com/helm/helm) | 3.18.4 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 2.38.2 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.75.0 | 
| [yarn](https://yarnpkg.com/) | 1.22.22 | /usr/bin |
| [Maven](https://maven.apache.org/) | 3.9.10 | /usr/local/sdkman/candidates/maven/current/bin |
| [Gradle](https://gradle.org/) | 8.14.2 | /usr/local/sdkman/candidates/gradle/current/bin |
| Docker (Moby) CLI &amp; Engine | 28.3.2 | 
| [conda](https://github.com/conda/conda) | 25.5.1 | /opt/conda/bin |
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 28.3.2-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 28.3.2-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.1 |
| ncdu | 1.19-0.1 |
