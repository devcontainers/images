...
**Digest:** sha256:475b4e65a3cbcabbb6a2abbb69481d641b37e274cbfda5d2fc7dae45d494eaf7
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 22.22.1<br />24.14.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
| [Python](https://www.python.org/) | 3.11.9<br />3.12.1 | /usr/local/python/&lt;version&gt; |
| [Java](https://adoptopenjdk.net/) | 21.0.10<br />25.0.2 | /usr/local/sdkman/candidates/java/&lt;version&gt; |
| [.NET](https://dotnet.microsoft.com/) | 10.0.201 | /usr/share/dotnet/dotnet |
...
| [Go](https://golang.org/dl) | 1.26.1 | /usr/local/go |
| [Jekyll](https://jekyllrb.com/) | 4.4.1 | 
| [Jupyter Lab](https://jupyter.org/) | 4.5.6 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | df64afb062707212180324f83b3d92e573d709ce | /home/codespace/.oh-my-zsh |
...
| [ruby-build](https://github.com/rbenv/ruby-build.git) | aa270b3d3309d5d1359feeddef3f10759cb50361 | /usr/local/share/ruby-build |
...
| [Xdebug](https://xdebug.org/) | 3.5.1 | /usr/local/php/current |
| [Composer](https://getcomposer.org/) | 2.9.5 | /usr/local/php/current/bin |
| [kubectl](https://github.com/kubernetes/kubectl) | v1.35.3 | /usr/local/bin |
| [Helm](https://github.com/helm/helm) | 4.1.3 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 2.40.3 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.88.1 | 
| [yarn](https://yarnpkg.com/) | ! Corepack is about to download https://registry.yarnpkg.com/yarn/-/yarn-1.22.22.tgz<br />1.22.22 | /usr/bin |
| [Maven](https://maven.apache.org/) | 3.9.14 | /usr/local/sdkman/candidates/maven/current/bin |
| [Gradle](https://gradle.org/) | 9.4.1 | /usr/local/sdkman/candidates/gradle/current/bin |
| Docker (Moby) CLI &amp; Engine | 29.3.0 | 
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.3.0-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 29.3.0-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.1 |
| ncdu | 1.19-0.1 |
...
| vim-doc | 2:9.1.0016-1ubuntu7.10 |
| vim-tiny | 2:9.1.0016-1ubuntu7.10 |
