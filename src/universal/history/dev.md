...
| Docker (Moby) CLI &amp; Engine | 26.1.1 | 
| [conda](https://github.com/conda/conda) | 24.4.0 | /opt/conda/bin |
...
| manpages | 5.05-1 |
| manpages-dev | 5.05-1 |
| moby-cli (Docker CLI) | 26.1.1-ubuntu20.04u1 |
| moby-engine (Docker Engine) | 26.1.1-ubuntu20.04u1 |
| nano | 4.8-1ubuntu1 |
| ncdu | 1.14.1-1 |
