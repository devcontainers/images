...
**Digest:** sha256:25e472d15caf48728458e1a4afc400a1a5a9ff877f62233d8466d327e9384e48
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 22.22.3<br />24.16.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
...
| [.NET](https://dotnet.microsoft.com/) | 10.0.300 | /usr/share/dotnet/dotnet |
...
| [Jupyter Lab](https://jupyter.org/) | 4.5.8 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 630a7c04c309a53f15e6a433c859867db17cc90e | /home/codespace/.oh-my-zsh |
...
| [Composer](https://getcomposer.org/) | 2.10.1 | /usr/local/php/current/bin |
| [kubectl](https://github.com/kubernetes/kubectl) | v1.36.1 | /usr/local/bin |
| [Helm](https://github.com/helm/helm) | 4.2.0 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 2.40.3 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.93.0 | 
...
| [Gradle](https://gradle.org/) | 9.5.1 | /usr/local/sdkman/candidates/gradle/current/bin |
| Docker (Moby) CLI &amp; Engine | 29.5.3 | 
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.5.3-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 29.5.3-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.2 |
| ncdu | 1.19-0.1 |
...
| vim-doc | 2:9.1.0016-1ubuntu7.14 |
