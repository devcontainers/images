...
**Digest:** sha256:7d4d1d4b504cbf3b2a4a99519cbfd23fb275214a6cb6ceb39fe2ad2ac19d7148
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 22.21.1<br />24.12.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
...
| [.NET](https://dotnet.microsoft.com/) | 10.0.101 | /usr/share/dotnet/dotnet |
...
| [Go](https://golang.org/dl) | 1.25.5 | /usr/local/go |
| [Jekyll](https://jekyllrb.com/) | 4.4.1 | 
| [Jupyter Lab](https://jupyter.org/) | 4.5.1 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 0f45f82c0afdcaf71b193e349d01c069a3fb9de7 | /home/codespace/.oh-my-zsh |
...
| [Helm](https://github.com/helm/helm) | 4.0.4 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 2.40.3 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.83.2 | 
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.1.3-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 28.5.2-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.1 |
| ncdu | 1.19-0.1 |
