...
**Digest:** sha256:d0a53bdd28d9b3bf571ccc79720d60f4f87f616b2b143fbea1d31834225630bb
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 22.23.2<br />24.19.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
...
| [.NET](https://dotnet.microsoft.com/) | 10.0.302 | /usr/share/dotnet/dotnet |
...
| [Go](https://golang.org/dl) | 1.26.5 | /usr/local/go |
| [Jekyll](https://jekyllrb.com/) | 4.4.1 | 
| [Jupyter Lab](https://jupyter.org/) | 4.6.2 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 97b27bb2ec0701330b18c2d3e340b22e742b3fa8 | /home/codespace/.oh-my-zsh |
...
| [kubectl](https://github.com/kubernetes/kubectl) | v1.36.3 | /usr/local/bin |
| [Helm](https://github.com/helm/helm) | 4.2.3 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 5.4.0 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.97.0 | 
| [yarn](https://yarnpkg.com/) | 1.22.22 | /usr/bin |
| [Maven](https://maven.apache.org/) | 3.9.16 | /usr/local/sdkman/candidates/maven/current/bin |
| [Gradle](https://gradle.org/) | 9.7.0 | /usr/local/sdkman/candidates/gradle/current/bin |
| Docker (Moby) CLI &amp; Engine | 29.7.2 | 
| [conda](https://github.com/conda/conda) | 26.7.0 | /opt/conda/bin |
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.7.2-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 29.7.2-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.2 |
| ncdu | 1.19-0.1 |
...
| vim-doc | 2:9.1.0016-1ubuntu7.18 |
