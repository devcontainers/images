...
**Digest:** sha256:5dfed767e7d9caf27a14c7a58b0f2c341ec1847fc43c808f53abc29fd6e304af
...
|--------------------|---------|------|
| [Node.js](https://nodejs.org/en/) | 20.19.0<br />22.14.0 | /usr/local/share/nvm/versions/node/&lt;version&gt; |
...
| [.NET](https://dotnet.microsoft.com/) | 8.0.407 | /usr/share/dotnet/dotnet |
...
| [Jupyter Lab](https://jupyter.org/) | 4.3.6 | /home/codespace/.local/bin/jupyter-lab |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | f81259fb344685e2dc8b67f8ad8764ccd4e8502e | /home/codespace/.oh-my-zsh |
...
| github.com/mgechev/revive | 1.8.0 |
...
| [kubectl](https://github.com/kubernetes/kubectl) | v1.32.3 | /usr/local/bin |
| [Helm](https://github.com/helm/helm) | 3.17.2 | /usr/local/bin |
| [Docker Compose](https://github.com/docker/compose) | 2.34.0 | /usr/local/bin |
| [rvm](https://github.com/rvm/rvm) | 1.29.12 | /usr/local/rvm |
| [GitHub CLI](https://github.com/cli/cli) | 2.69.0 | 
...
| Docker (Moby) CLI &amp; Engine | 28.0.4 | 
| [conda](https://github.com/conda/conda) | 25.3.0 | /opt/conda/bin |
...
| manpages | 5.05-1 |
| manpages-dev | 5.05-1 |
| moby-cli (Docker CLI) | 28.0.4-ubuntu20.04u1 |
| moby-engine (Docker Engine) | 28.0.3-ubuntu20.04u1 |
| nano | 4.8-1ubuntu1.1 |
| ncdu | 1.14.1-1 |
