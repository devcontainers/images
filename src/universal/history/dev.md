...
**Digest:** sha256:8ec0fa989279983e85fd16cc6db4ef7c278956fd13f615f963f4a39c44a4c3a0
...
| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 70ad5e3df8f7bed68aa6672029496926e632aedd | /home/codespace/.oh-my-zsh |
...
| [Composer](https://getcomposer.org/) | 2.10.0 | /usr/local/php/current/bin |
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.5.2-ubuntu24.04u2 |
| moby-engine (Docker Engine) | 29.5.2-ubuntu24.04u3 |
| nano | 7.2-2ubuntu0.1 |
| ncdu | 1.19-0.1 |
