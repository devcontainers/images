...
**Source release/branch:** [v0.4.33](https://github.com/devcontainers/images/tree/v0.4.33/src/universal)

**Digest:** sha256:584e41561451c910dcd96221634be07545803aed9cd437a60288f06ddeaf5880

**Tags:**
```
mcr.microsoft.com/devcontainers/universal:6.1.7-noble
mcr.microsoft.com/devcontainers/universal:6.1.7-linux
mcr.microsoft.com/devcontainers/universal:6.1.7
```
...
| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 24d629f7f1eda1eaa4c8918e5c838b330ff96f28 | /home/codespace/.oh-my-zsh |
...
| manpages | 6.7-2 |
| manpages-dev | 6.7-2 |
| moby-cli (Docker CLI) | 29.8.0-ubuntu24.04u1 |
| moby-engine (Docker Engine) | 29.8.0-ubuntu24.04u1 |
| nano | 7.2-2ubuntu0.2 |
| ncdu | 1.19-0.1 |
