...
**Source release/branch:** [v0.4.24](https://github.com/devcontainers/images/tree/v0.4.24/src/universal)

**Digest:** sha256:feeaa66d9deb342b5a5a9fdcf8afef18689cd284359a67a62289a77772573337

**Tags:**
```
mcr.microsoft.com/devcontainers/universal:5.1.4-noble
mcr.microsoft.com/devcontainers/universal:5.1.4-linux
mcr.microsoft.com/devcontainers/universal:5.1.4
```
