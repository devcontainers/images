...
- `mcr.microsoft.com/devcontainers/typescript-node:6-24` (or `6-24-trixie`, `6-24-bookworm`)
- `mcr.microsoft.com/devcontainers/typescript-node:6.0-24` (or `6.0-24-trixie`, `6.0-24-bookworm`)
- `mcr.microsoft.com/devcontainers/typescript-node:6.0.0-24` (or `6.0.0-24-trixie`, `6.0.0-24-bookworm`)
