...
**Source release/branch:** [v0.3.13](https://github.com/devcontainers/images/tree/v0.3.13/src/base-debian)
...
**Digest:** sha256:d070674b0bf615e732bab60dedeeea82b0cc62186d8a63b93ba2df065ad77f4e

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.2-bookworm
mcr.microsoft.com/devcontainers/base:1.0.2-debian-12
mcr.microsoft.com/devcontainers/base:1.0.2-debian12
mcr.microsoft.com/devcontainers/base:1.0.2-debian
mcr.microsoft.com/devcontainers/base:1.0.2
```
...
**Digest:** sha256:6db6c698ea9506680b16b062147213e39b325546e7a6845b49e1a55a4b2e1ca0

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.2-buster
mcr.microsoft.com/devcontainers/base:1.0.2-debian-10
mcr.microsoft.com/devcontainers/base:1.0.2-debian10
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.2-bullseye
mcr.microsoft.com/devcontainers/base:1.0.2-debian-11
mcr.microsoft.com/devcontainers/base:1.0.2-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
