...
**Image version:** 2.1.10

**Source release/branch:** [v0.4.28](https://github.com/devcontainers/images/tree/v0.4.28/src/base-debian)
...
**Digest:** sha256:b60cd6e70901c42c23dc312b8e0cf2c704cad3acf65c55739ff1ef33a30166d2

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.10-trixie
mcr.microsoft.com/devcontainers/base:2.1.10-debian13
mcr.microsoft.com/devcontainers/base:2.1.10-debian
mcr.microsoft.com/devcontainers/base:2.1.10
```
...
**Digest:** sha256:aba0f2e0730af481edf2db5582a80c0ed2591bee78ec177f7fa7a38e8f5e1105

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.10-bookworm
mcr.microsoft.com/devcontainers/base:2.1.10-debian12
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:a109759a394d8d154aa0e4d5cb110cbfd313514865d980c9627b2654329ebfe5

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.10-bullseye
mcr.microsoft.com/devcontainers/base:2.1.10-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
