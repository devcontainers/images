...
**Image version:** 2.1.13

**Source release/branch:** [v0.4.30](https://github.com/devcontainers/images/tree/v0.4.30/src/base-debian)
...
mcr.microsoft.com/devcontainers/base:2.1.13-debian13
mcr.microsoft.com/devcontainers/base:2.1.13-debian
mcr.microsoft.com/devcontainers/base:2.1.13
```
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.13-bookworm
mcr.microsoft.com/devcontainers/base:2.1.13-debian12
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:1c070dcf54d1d292585f963e78e15a15d5b8b2ebe248978172517596fd59367b

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.13-bullseye
mcr.microsoft.com/devcontainers/base:2.1.13-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
