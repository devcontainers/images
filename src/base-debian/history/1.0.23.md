...
**Source release/branch:** [v0.4.16](https://github.com/devcontainers/images/tree/v0.4.16/src/base-debian)
...
**Digest:** sha256:da67c59f82e057e0ccb81ec7d13fb50464c26f477638018e6de1b2623a008a3a

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.23-bookworm
mcr.microsoft.com/devcontainers/base:1.0.23-debian-12
mcr.microsoft.com/devcontainers/base:1.0.23-debian12
mcr.microsoft.com/devcontainers/base:1.0.23-debian
mcr.microsoft.com/devcontainers/base:1.0.23
```
...
**Digest:** sha256:c28379864b888ff21bbe8f715a059567db8de8bb65755ab265e03525839a9ed5

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.23-bullseye
mcr.microsoft.com/devcontainers/base:1.0.23-debian-11
mcr.microsoft.com/devcontainers/base:1.0.23-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
