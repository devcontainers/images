...
**Source release/branch:** [v0.4.11](https://github.com/devcontainers/images/tree/v0.4.11/src/base-debian)
...
**Digest:** sha256:577ed426ea0beda5fe12f135ca9355e95adc1ab2cede18d11e4ec583d877da81

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.20-bookworm
mcr.microsoft.com/devcontainers/base:1.0.20-debian-12
mcr.microsoft.com/devcontainers/base:1.0.20-debian12
mcr.microsoft.com/devcontainers/base:1.0.20-debian
mcr.microsoft.com/devcontainers/base:1.0.20
```
...
**Digest:** sha256:0b3c5ffb423d8ed2a7698d6a2bcf49f0fec8c6bb867f7d878d5af16e8ddae47d

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.20-bullseye
mcr.microsoft.com/devcontainers/base:1.0.20-debian-11
mcr.microsoft.com/devcontainers/base:1.0.20-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
