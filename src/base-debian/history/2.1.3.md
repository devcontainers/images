...
**Source release/branch:** [v0.4.22](https://github.com/devcontainers/images/tree/v0.4.22/src/base-debian)
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.3-trixie
mcr.microsoft.com/devcontainers/base:2.1.3-debian13
mcr.microsoft.com/devcontainers/base:2.1.3-debian
mcr.microsoft.com/devcontainers/base:2.1.3
```
...
**Digest:** sha256:1d5ccf8d7fe290a16617e55a2f10dcf7856c765d4894bf6e9cf54ec0491a4a7f

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.3-bookworm
mcr.microsoft.com/devcontainers/base:2.1.3-debian12
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:03e618ae2b25d068f292c99220b2b055007694d1e1ad7fac34b02d8060a7f504

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.3-bullseye
mcr.microsoft.com/devcontainers/base:2.1.3-debian11
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
