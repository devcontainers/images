...
Development tags are preview builds from `main`. Use `mcr.microsoft.com/devcontainers/rust:dev-1` to test the current image definition before its next stable release.
...
- `mcr.microsoft.com/devcontainers/rust:2.0.14-1` (or `2.0.14-1-trixie`, `2.0.14-1-bookworm`, `2.0.14-1-bullseye` to pin to an OS version)
