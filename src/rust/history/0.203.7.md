...
**Source release/branch:** [v0.2.42](https://github.com/devcontainers/images/tree/v0.2.42/src/rust)
...
**Tags:**
```
mcr.microsoft.com/devcontainers/rust:0.203.7-buster
mcr.microsoft.com/devcontainers/rust:0.203.7-1
mcr.microsoft.com/devcontainers/rust:0.203.7-1-buster
```
...
**Tags:**
```
mcr.microsoft.com/devcontainers/rust:0.203.7-bullseye
mcr.microsoft.com/devcontainers/rust:0.203.7-1-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
