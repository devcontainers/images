...
**Source release/branch:** [v0.3.26](https://github.com/devcontainers/images/tree/v0.3.26/src/rust)
...
**Digest:** sha256:971f8008e5d5a4074ae8b4bc19a057321d65249036e8b3b1df2c79d0bf6a1069

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:1.0.6-bookworm
mcr.microsoft.com/devcontainers/rust:1.0.6-1
mcr.microsoft.com/devcontainers/rust:1.0.6-1-bookworm
```
...
|--------------------|---------|------|
| [Rust](https://github.com/rust-lang/rust) | 1.74.1 | /usr/local/cargo<br />/usr/local/rustup |
...
**Digest:** sha256:be7935d8922cc8b430becac30ec701755643bd74b978268495e659d09909e51c

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:1.0.6-buster
mcr.microsoft.com/devcontainers/rust:1.0.6-1-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:4ae15759784f9c1dbe6d53080a3e679046e51dd08f087e9ed212b59b2aef3fb8

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:1.0.6-bullseye
mcr.microsoft.com/devcontainers/rust:1.0.6-1-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
