...
-  - `mcr.microsoft.com/devcontainers/php:8.5` (or `8.5-trixie`, `8.5-bookworm`, `8.5-bullseye` to pin to an OS version)
...
- `mcr.microsoft.com/devcontainers/php:3-8` (or `3-8-trixie`, `3-8-bookworm`, `3-8-bullseye` )
- `mcr.microsoft.com/devcontainers/php:2.0-8` (or `3.0-8-trixie`,`3.0-8-bookworm`, `3.0-8-bullseye` )
- `mcr.microsoft.com/devcontainers/php:2.0.0-8` (or `3.0.0-8-trixie`, `3.0.0-8-bookworm`, `3.0.0-8-bullseye` )
