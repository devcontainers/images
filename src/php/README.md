...
| *Published images* | ghcr.io/sebst/devcontainers/php |
| *Available image variants* | 8 / 8-trixie, 8.5 / 8.5-trixie, 8.4 / 8.4-trixie, 8.3 / 8.3-trixie, 8.2 / 8.2-trixie, 8-bookworm, 8.5-bookworm, 8.4-bookworm, 8.3-bookworm, 8.2-bookworm ([full list](https://ghcr.io/v2/sebst/devcontainers/php/tags/list)) |
...
- `ghcr.io/sebst/devcontainers/php` (latest)
- `ghcr.io/sebst/devcontainers/php:8` (or `8-trixie`, `8-bookworm` to pin to an OS version)
- `ghcr.io/sebst/devcontainers/php:8.5` (or `8.5-trixie`, `8.5-bookworm` to pin to an OS version)
- `ghcr.io/sebst/devcontainers/php:8.4` (or `8.4-trixie`, `8.4-bookworm` to pin to an OS version)
- `ghcr.io/sebst/devcontainers/php:8.3` (or `8.3-trixie`, `8.3-bookworm` to pin to an OS version)
- `ghcr.io/sebst/devcontainers/php:8.2` (or `8.2-trixie`, `8.2-bookworm` to pin to an OS version)

Refer to [this guide](https://containers.dev/guide/dockerfile) for more details.

You can decide how often you want updates by referencing a [semantic version](https://semver.org/) of each image. For example:

- `ghcr.io/sebst/devcontainers/php:3-8` (or `3-8-trixie`, `3-8-bookworm` )
- `ghcr.io/sebst/devcontainers/php:3.0-8` (or `3.0-8-trixie`, `3.0-8-bookworm` )
- `ghcr.io/sebst/devcontainers/php:3.0.4-8` (or `3.0.4-8-trixie`, `3.0.4-8-bookworm` )
...
See [history](history) for information on the contents of each version and [here for a complete list of available tags](https://ghcr.io/v2/sebst/devcontainers/php/tags/list).
