...
| *Available image variants* | 8 / 8-trixie, 8.5 / 8.5-trixie, 8.4 / 8.4-trixie, 8.3 / 8.3-trixie, 8-bookworm, 8.5-bookworm, 8.4-bookworm, 8.3-bookworm ([full list](https://mcr.microsoft.com/v2/devcontainers/php/tags/list)) |
...
Development tags are preview builds from `main`. Use `mcr.microsoft.com/devcontainers/php:dev-8.5` to test the current image definition before its next stable release.
...
- `mcr.microsoft.com/devcontainers/php:4.1.1-8` (or `4.1.1-8-trixie`, `4.1.1-8-bookworm` )
