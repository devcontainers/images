...
Development tags are preview builds from `main`. Use `mcr.microsoft.com/devcontainers/anaconda:dev-3` to test the current image definition before its next stable release.
