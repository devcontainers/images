...
**Source release/branch:** [v0.4.25](https://github.com/devcontainers/images/tree/v0.4.25/src/java-8)
...
**Digest:** sha256:e37d8e6a801ecc687bff9fa6bfefc401adc24665f1d0212098e882f508ef62ce

**Tags:**
```
mcr.microsoft.com/devcontainers/java:3.0.7-8-trixie
mcr.microsoft.com/devcontainers/java:3.0.7-8
mcr.microsoft.com/devcontainers/java:3.0.7-8-jdk-trixie
```
...
**Digest:** sha256:268683a7279bd22f29f0d32187e94f7b0be51e5278de3e1a8ec9080b223f36a8

**Tags:**
```
mcr.microsoft.com/devcontainers/java:3.0.7-8-bookworm
mcr.microsoft.com/devcontainers/java:3.0.7-8-jdk-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
