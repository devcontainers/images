...
**Image version:** 2.0.27

**Source release/branch:** [v0.4.18](https://github.com/devcontainers/images/tree/v0.4.18/src/java-8)
...
**Digest:** sha256:15473421b43f253f82bc89ee6cd5183591177a5264cd3cd7e58a14b151f75618

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.27-8-bookworm
mcr.microsoft.com/devcontainers/java:2.0.27-8
mcr.microsoft.com/devcontainers/java:2.0.27-8-jdk-bookworm
```
...
**Digest:** sha256:a37253da05ccf889cba632ad6ac7b5df369b0ed24ba513cb952978a8edf196cd

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.27-8-bullseye
mcr.microsoft.com/devcontainers/java:2.0.27-8-jdk-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
