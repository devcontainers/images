...
**Source release/branch:** [v0.2.29](https://github.com/devcontainers/images/tree/v0.2.29/src/java-8)
...
**Digest:** sha256:b909c8b063c954be5a412ab7a67740a2134a635ff91d84d5799e7b968e58b214

**Tags:**
```
mcr.microsoft.com/devcontainers/java:1.0.10-8-bullseye
mcr.microsoft.com/devcontainers/java:1.0.10-8-jdk-bullseye
```
...
**Digest:** sha256:6276939018c4593fe027e0464da1d24afeb9aee0ac740874b57317a84b08de6d

**Tags:**
```
mcr.microsoft.com/devcontainers/java:1.0.10-8-buster
mcr.microsoft.com/devcontainers/java:1.0.10-8
mcr.microsoft.com/devcontainers/java:1.0.10-8-jdk-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
