...
**Image version:** 2.0.23

**Source release/branch:** [v0.4.15](https://github.com/devcontainers/images/tree/v0.4.15/src/java-8)
...
**Digest:** sha256:bdc83bfd161b9b945215fe57cf91e620611518a37b9b2fa0673c693067e54b7c

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.23-8-bookworm
mcr.microsoft.com/devcontainers/java:2.0.23-8
mcr.microsoft.com/devcontainers/java:2.0.23-8-jdk-bookworm
```
...
**Digest:** sha256:44bb36a2e1347441271a33c0fe588620979061173ffe1311031df9e3cc87ae81

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.23-8-bullseye
mcr.microsoft.com/devcontainers/java:2.0.23-8-jdk-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
