...
**Source release/branch:** [v0.3.30](https://github.com/devcontainers/images/tree/v0.3.30/src/java-8)
...
**Digest:** sha256:e830bb2ceb5a12c3b177bbe33b947df48c2ed53a146e19987ba29e27405131f3

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.8-8-bookworm
mcr.microsoft.com/devcontainers/java:2.0.8-8
mcr.microsoft.com/devcontainers/java:2.0.8-8-jdk-bookworm
```
...
**Digest:** sha256:503fcdef2d596b1cfac4af324717e4726787cb09955557303ad65770a7466ad5

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.8-8-bullseye
mcr.microsoft.com/devcontainers/java:2.0.8-8-jdk-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:2d238df4c2ada9663342e96ab829d88f4691c7c213523bc5403802c11afdf255

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.8-8-buster
mcr.microsoft.com/devcontainers/java:2.0.8-8-jdk-buster
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
