...
**Source release/branch:** [v0.4.11](https://github.com/devcontainers/images/tree/v0.4.11/src/java-8)
...
**Digest:** sha256:bd4e201c5d8c7fb1592c76d380abe467ce51cfe9c04acab0011460c9ba963202

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.21-8-bookworm
mcr.microsoft.com/devcontainers/java:2.0.21-8
mcr.microsoft.com/devcontainers/java:2.0.21-8-jdk-bookworm
```
...
**Digest:** sha256:5b8a1e15c06adf3bc6e83f784818f5f7de1693a5719c7855d3e5cd707306475e

**Tags:**
```
mcr.microsoft.com/devcontainers/java:2.0.21-8-bullseye
mcr.microsoft.com/devcontainers/java:2.0.21-8-jdk-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
