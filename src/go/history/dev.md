...
**Digest:** sha256:1fa7e70dad030eb81d2d44443826a76597df15921b045244b6601b6615f9e3a7

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.22-bookworm
mcr.microsoft.com/devcontainers/go:dev-1.22
...
**Digest:** sha256:2d6a522d2d04bf24f54700e1035426ff5652ce69ff0ba822a7578417c29a830a

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.21-bookworm
mcr.microsoft.com/devcontainers/go:dev-1.21
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [Go](https://golang.org/dl) | 1.21.7 | /usr/local/go |
...
**Digest:** sha256:7b93d36c6ad8287892c162ca7f8bcba67b4ea89f5b1e6fd1a0fc6fc734fb6261

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.20-bookworm
mcr.microsoft.com/devcontainers/go:dev-1.20
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [Go](https://golang.org/dl) | 1.20.14 | /usr/local/go |
...
**Digest:** sha256:d29b65800a560cb5f933899dbad6436fc9281f955ac5579b24e0f02645fb3140

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.22-bullseye
...
**Digest:** sha256:65c0be2ca90ee18a4bca040f3724161d388d409c7236325219c896b872696099

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.21-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:7c9b9a714daad46baf20ceb9a37f0739d3a7220ac3d278c8d1f821275194a82c

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.20-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
