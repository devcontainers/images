...
**Image variations:**
- [1.27-trixie](#variant-127-trixie)
- [1.26-trixie](#variant-126-trixie)
- [1.25-trixie](#variant-125-trixie)
- [1.27-bookworm](#variant-127-bookworm)
- [1.26-bookworm](#variant-126-bookworm)
- [1.25-bookworm](#variant-125-bookworm)

## Variant: 1.27-trixie

**Digest:** sha256:c1855a9e19660f6bcd7e7fe0dafc53defc11f6adf7a478565272719a546b11bc

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.27-trixie
mcr.microsoft.com/devcontainers/go:dev-1.27
...
**Digest:** sha256:a49322c430ddbb7d8e854ca04ce5410dbce3a7ca7fea334923f3f8f0fa89450a

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.26-trixie
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [Go](https://golang.org/dl) | 1.26.8 | /usr/local/go |

**Tools installed using git**

| Tool | Commit | Path |
|------|--------|------|
| [Oh My Zsh!](https://github.com/ohmyzsh/ohmyzsh) | 0ee67f042872d1dfab74270c31867771ca35aef4 | /home/vscode/.oh-my-zsh |
| [nvm](https://github.com/nvm-sh/nvm.git) | f0b0c6bb0b281ceeb106c8cf9ab8fde141215092 | /usr/local/share/nvm |
...
**Digest:** sha256:214c5873effdb5acdb8a0ec6380fe4dc83535d969b8dd117c5c58e598e7d85a8
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [Go](https://golang.org/dl) | 1.25.14 | /usr/local/go |
...
**Digest:** sha256:6f19f514101062fefcb35497f15e136d71f9b78892083cfb5d35ab8989a5114b

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.27-bookworm
...
**Digest:** sha256:705269aa71ac072bad34810f7c9b4c7b80f74534c3084ec74068e3988cd5ead6

**Tags:**
```
mcr.microsoft.com/devcontainers/go:dev-1.26-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:dfad7419e5fb986d64e7722dd63d373584bf8ea67e0be6b898bb09005a75fd87
