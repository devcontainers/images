...
**Source release/branch:** [v0.4.16](https://github.com/devcontainers/images/tree/v0.4.16/src/go)
...
**Digest:** sha256:f7a740615ff205f7df9d531fb6aa864a38887956ddbd9a20be33df8a2924fa09

**Tags:**
```
mcr.microsoft.com/devcontainers/go:1.4.3-1.24-bookworm
mcr.microsoft.com/devcontainers/go:1.4.3-1.24
mcr.microsoft.com/devcontainers/go:1.4.3-1
mcr.microsoft.com/devcontainers/go:1.4.3-1-bookworm
mcr.microsoft.com/devcontainers/go:1.4.3-bookworm
```
...
**Digest:** sha256:f12d68fb2acd19b5b7a5833ab39e0ff1c16646f698713e3661fce0cb6cb3b590

**Tags:**
```
mcr.microsoft.com/devcontainers/go:1.4.3-1.23-bookworm
mcr.microsoft.com/devcontainers/go:1.4.3-1.23
mcr.microsoft.com/devcontainers/go:1.4.3-1
mcr.microsoft.com/devcontainers/go:1.4.3-1-bookworm
mcr.microsoft.com/devcontainers/go:1.4.3-bookworm
```
...
**Digest:** sha256:298026cef2159a48b1dd51b0517a35baa86dd0839d2a04598b8f1c1059177d0e

**Tags:**
```
mcr.microsoft.com/devcontainers/go:1.4.3-1.24-bullseye
mcr.microsoft.com/devcontainers/go:1.4.3-1-bullseye
mcr.microsoft.com/devcontainers/go:1.4.3-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:91c61d0824fd09436d01688fddc2e6cf4454f168065415082206c93cafc23341

**Tags:**
```
mcr.microsoft.com/devcontainers/go:1.4.3-1.23-bullseye
mcr.microsoft.com/devcontainers/go:1.4.3-1-bullseye
mcr.microsoft.com/devcontainers/go:1.4.3-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
