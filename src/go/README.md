...
- `mcr.microsoft.com/devcontainers/go:2.2-1.27` (or `2.2-1.27-trixie`, `2.2-1.27-bookworm`)
- `mcr.microsoft.com/devcontainers/go:2.2.2-1.27` (or `2.2.2-1.27-trixie`, `2.2.2-1.27-bookworm`)
