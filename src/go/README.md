...
- `mcr.microsoft.com/devcontainers/go:2.2-1.26` (or `2.2-1.26-trixie`, `2.2-1.26-bookworm`)
- `mcr.microsoft.com/devcontainers/go:2.2.2-1.26` (or `2.2.2-1.26-trixie`, `2.2.2-1.26-bookworm`)
