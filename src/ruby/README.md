...
Development tags are preview builds from `main`. Use `mcr.microsoft.com/devcontainers/ruby:dev-4` to test the current image definition before its next stable release.
...
- `mcr.microsoft.com/devcontainers/ruby:4.1.0-4` (or `4.1.0-4-trixie`, `4.1.0-4-bookworm` to pin to an OS version)
