...
| *Available image variants* | 11 / 11-trixie, 17 /17-trixie, , 21 / 21-trixie, 21-bookworm, 17-bookworm, 11-bookworm,  11-bullseye, 17-bullseye, 21-bullseye ([full list](https://mcr.microsoft.com/v2/devcontainers/java/tags/list)) |
...
- `mcr.microsoft.com/devcontainers/java:21` (or `21-trixie`, `21-bookworm`, `21-bullseye` to pin to an OS version)
