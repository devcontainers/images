...
| *Available image variants* | 11 / 11-bookworm, 17 / 17-bookworm, 21 / 21-bookworm, 24 / 24-bookworm, 11-bullseye, 17-bullseye, 21-bullseye, 24-bullseye ([full list](https://mcr.microsoft.com/v2/devcontainers/java/tags/list)) |
...
- `mcr.microsoft.com/devcontainers/java:24` (or `24-bookworm`, `24-bullseye` to pin to an OS version) (latest NON-LTS)
- `mcr.microsoft.com/devcontainers/java` (latest LTS)
