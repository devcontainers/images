...
**Source release/branch:** [v0.3.22](https://github.com/devcontainers/images/tree/v0.3.22/src/base-ubuntu)
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.17-jammy
mcr.microsoft.com/devcontainers/base:1.0.17-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:1.0.17-ubuntu22.04
mcr.microsoft.com/devcontainers/base:1.0.17-ubuntu
```
...
**Digest:** sha256:3657c4b49ebf4d8adf69cccab3d1e3ec401bfd39ba917aec07883877bd71f229

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.17-focal
mcr.microsoft.com/devcontainers/base:1.0.17-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:1.0.17-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
