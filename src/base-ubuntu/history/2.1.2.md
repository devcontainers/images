...
**Source release/branch:** [v0.4.21](https://github.com/devcontainers/images/tree/v0.4.21/src/base-ubuntu)
...
**Digest:** sha256:8d68bbf458958747a7f41756f60de95d5b404f374f05cd42969957653fad0cfe

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.2-noble
mcr.microsoft.com/devcontainers/base:2.1.2-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.1.2-ubuntu
```
...
**Digest:** sha256:658946bf6191bf0158739bfe3909acd8e8c3294ce5d1cd21a9aaf38134384339

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.2-jammy
mcr.microsoft.com/devcontainers/base:2.1.2-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
