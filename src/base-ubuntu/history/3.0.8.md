...
**Source release/branch:** [v0.4.33](https://github.com/devcontainers/images/tree/v0.4.33/src/base-ubuntu)
...
**Digest:** sha256:edfb983aab9c579a385dc23c57d7d3703f5ec920124d99c16204a2cac465aab4

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.8-resolute
mcr.microsoft.com/devcontainers/base:3.0.8-ubuntu26.04
mcr.microsoft.com/devcontainers/base:3.0.8-ubuntu
```
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.8-noble
mcr.microsoft.com/devcontainers/base:3.0.8-ubuntu24.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:833a9eb9b48b57160531c9ea552d942d4d428ec58d76305d43f4976419b32173

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.8-jammy
mcr.microsoft.com/devcontainers/base:3.0.8-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
