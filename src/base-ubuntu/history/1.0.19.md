...
**Source release/branch:** [v0.3.26](https://github.com/devcontainers/images/tree/v0.3.26/src/base-ubuntu)
...
**Digest:** sha256:0ec453075ac1fbf796d3256f1f336bf906961e8c36f7f5035251b5025164228f

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.19-jammy
mcr.microsoft.com/devcontainers/base:1.0.19-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:1.0.19-ubuntu22.04
mcr.microsoft.com/devcontainers/base:1.0.19-ubuntu
```
...
**Digest:** sha256:7d874c548ad2b5b59a4eecd4561675af8c4210f2e9b6a341a398b4d316b62858

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.19-focal
mcr.microsoft.com/devcontainers/base:1.0.19-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:1.0.19-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
