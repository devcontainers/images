...
**Source release/branch:** [v0.4.28](https://github.com/devcontainers/images/tree/v0.4.28/src/base-ubuntu)
...
**Digest:** sha256:d1fc409bd576f7b6f81c5cfd7399ac8b26d0fd80ba0d2eb269b1e6e1f151d22b

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.2-resolute
mcr.microsoft.com/devcontainers/base:3.0.2-ubuntu26.04
mcr.microsoft.com/devcontainers/base:3.0.2-ubuntu
```
...
**Digest:** sha256:6e5abd134eb1c2b747927487c3d59590bcc17815d5d7b3afd494e1be5de0f6b4

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.2-noble
mcr.microsoft.com/devcontainers/base:3.0.2-ubuntu24.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:623f0c32f171e8e869ded33335c6fb20a4fbc3c2229037bd4a09d48a7cca65bf

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.2-jammy
mcr.microsoft.com/devcontainers/base:3.0.2-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
