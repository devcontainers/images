...
**Source release/branch:** [v0.4.22](https://github.com/devcontainers/images/tree/v0.4.22/src/base-ubuntu)
...
**Digest:** sha256:c1613dbcdafe28e4b36ede9f3cb84a96e76765f50b3aeee87cb589eeb4c6dbca

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.3-noble
mcr.microsoft.com/devcontainers/base:2.1.3-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.1.3-ubuntu
```
...
**Digest:** sha256:700ae3efa1b774f7e9834745492089d5fa35b643196152c39a8f18dd37a4ff4e

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.3-jammy
mcr.microsoft.com/devcontainers/base:2.1.3-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
