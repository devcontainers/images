...
**Source release/branch:** [v0.4.23](https://github.com/devcontainers/images/tree/v0.4.23/src/base-ubuntu)
...
**Digest:** sha256:e93b9972fde44e07ffa51010b880eecc1753b2b7414c7d448554aab38cf2d489

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.5-noble
mcr.microsoft.com/devcontainers/base:2.1.5-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.1.5-ubuntu
```
...
**Digest:** sha256:2921a258f9412dc091956ee835986e2b3fba0ffa7a6d34b1df86d28c80814a56

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.5-jammy
mcr.microsoft.com/devcontainers/base:2.1.5-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
