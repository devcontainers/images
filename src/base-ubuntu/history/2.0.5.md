...
**Source release/branch:** [v0.4.19](https://github.com/devcontainers/images/tree/v0.4.19/src/base-ubuntu)
...
**Digest:** sha256:d94c97dd9cacf183d0a6fd12a8e87b526e9e928307674ae9c94139139c0c6eae

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.0.5-noble
mcr.microsoft.com/devcontainers/base:2.0.5-ubuntu-24.04
mcr.microsoft.com/devcontainers/base:2.0.5-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.0.5-ubuntu
```
...
**Digest:** sha256:81380e4c9c14e8a629ff39029639e4b7893e67400246fa7782a0fe7dc193a02a

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.0.5-jammy
mcr.microsoft.com/devcontainers/base:2.0.5-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:2.0.5-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
