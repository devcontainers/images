...
**Source release/branch:** [v0.4.27](https://github.com/devcontainers/images/tree/v0.4.27/src/base-ubuntu)
...
**Digest:** sha256:bb779775cfc7d2e65f9b0f80f17770878f5a50c00d15cc873b627c5c214ce37e

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.1-resolute
mcr.microsoft.com/devcontainers/base:3.0.1-ubuntu26.04
mcr.microsoft.com/devcontainers/base:3.0.1-ubuntu
```
...
**Digest:** sha256:405175cbb232701dc27c47a2f178da555ea3ad20f85ea4142ad6a24f877af399

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.1-noble
mcr.microsoft.com/devcontainers/base:3.0.1-ubuntu24.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:f2d74267998cfe76acefa5cc8d19ccc86bb2ba4520a5ad2b218def9566dc04cd
