...
**Source release/branch:** [v0.3.27](https://github.com/devcontainers/images/tree/v0.3.27/src/base-ubuntu)
...
**Digest:** sha256:291e12f053b701cbe0ef13b446cf3e0db3c395e1023a53c83bf7f63755cb717c

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.20-jammy
mcr.microsoft.com/devcontainers/base:1.0.20-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:1.0.20-ubuntu22.04
mcr.microsoft.com/devcontainers/base:1.0.20-ubuntu
```
...
**Digest:** sha256:b887a2dc6b54da277c557848364e0ce1360070eebd375d78b4d8cee5e4962c95

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.20-focal
mcr.microsoft.com/devcontainers/base:1.0.20-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:1.0.20-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
