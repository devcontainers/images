...
**Source release/branch:** [v0.4.24](https://github.com/devcontainers/images/tree/v0.4.24/src/base-ubuntu)
...
**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.6-noble
mcr.microsoft.com/devcontainers/base:2.1.6-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.1.6-ubuntu
```
...
**Digest:** sha256:59f3dd3c14e9370d005021f84d0d970fa388683fb8450cdd6bb199fdbf7e5f34

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.6-jammy
mcr.microsoft.com/devcontainers/base:2.1.6-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
