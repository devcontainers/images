...
**Source release/branch:** [v0.4.30](https://github.com/devcontainers/images/tree/v0.4.30/src/base-ubuntu)
...
**Digest:** sha256:1f8bb87ca6d342a587a9163a5a1ea8c487bcd4f149e8483a5ff711f795f0776d

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.5-resolute
mcr.microsoft.com/devcontainers/base:3.0.5-ubuntu26.04
mcr.microsoft.com/devcontainers/base:3.0.5-ubuntu
```
...
**Digest:** sha256:cfd5dd36c0d0d88de015aad5aa4f4b94e76d9f658a1e3055b27fd7d0fd1d84a6

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.5-noble
mcr.microsoft.com/devcontainers/base:3.0.5-ubuntu24.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:9a262db27066228e721a1ea5b83b5453e96da8f8ab4059524d2a39b67e6e5e92

**Tags:**
```
mcr.microsoft.com/devcontainers/base:3.0.5-jammy
mcr.microsoft.com/devcontainers/base:3.0.5-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
