...
**Source release/branch:** [v0.4.26](https://github.com/devcontainers/images/tree/v0.4.26/src/base-ubuntu)
...
**Digest:** sha256:7ee7da33a68d997971660d91ecc8372e55a38a777c3c6bd6808daf91928052db

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.8-noble
mcr.microsoft.com/devcontainers/base:2.1.8-ubuntu24.04
mcr.microsoft.com/devcontainers/base:2.1.8-ubuntu
```
...
**Digest:** sha256:55126de3b3e113096201055951b4cb717900bafb379c59dcbada65c49cd7ce22

**Tags:**
```
mcr.microsoft.com/devcontainers/base:2.1.8-jammy
mcr.microsoft.com/devcontainers/base:2.1.8-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
