...
- `mcr.microsoft.com/devcontainers/javascript-node:5.0-24` (or `5.0-24-trixie`, `5.0-24-bookworm`, `5.0-24-bullseye`)
- `mcr.microsoft.com/devcontainers/javascript-node:5.0.0-24` (or `5.0.0-24-trixie`, `5.0.0-24-bookworm`, `5.0.0-24-bullseye`)
